...
translate(v=[-5.5-10+1.5,10,51])  rotate(a=[90,0,0]) cylinder(h=15, r=2.4, center = true);
translate(v=[-5.5-10+1.5,10,6])  rotate(a=[90,0,0]) cylinder(h=15, r=2.4, center = true);
...
// Bottom pushfit rod
translate(v=[-15,-41.5,6]) rotate(a=[-90,0,0]) pushfit_rod(8.1,45);
// Top pushfit rod
translate(v=[-15,-41.5,rod_distance+6]) rotate(a=[-90,0,0]) pushfit_rod(8.1,45);
// Nut trap
